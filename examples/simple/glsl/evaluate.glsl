...
// base color (albedo?)
layout(binding = 1) uniform sampler2D mapBaseColorXY;
// HSV offset
layout(binding = 1) uniform sampler2D mapHSVOffsetXY;
// blur parameters
layout(binding = 1) uniform sampler2D mapBlurParametersXY;
// other ideas
// HSV warp map
...
layout(binding = 0) coherent uniform image2D imgTarget;
